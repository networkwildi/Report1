...
We have not covered stacked horizontal bar plot, so you will have to study the documentation, and/or some blog posts. There is also a great book about {ggplot2} recipes that I recommend you check out: The hitchhiker's guide to ggplot2. The book is pay-as-you-want, so select Package "The book" and choose a number from 0 and 30 dollars.
