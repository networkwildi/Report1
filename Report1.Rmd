...
the_total_is <- c("The total average of totally_agree and disagree is  ")   # text to vec
answer_average <- c(the_total_is, total_toal)                               # combine text and result to new vec  
print(answer_average)                                                       # print text and result
